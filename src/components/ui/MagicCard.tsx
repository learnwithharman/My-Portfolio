...
const DEFAULT_GLOW_COLOR = '132, 0, 255'; // Neon Purple default
...
const GlobalSpotlight: React.FC<{
    ...
    glowColor = DEFAULT_GLOW_COLOR
        ...
        useEffect(() => {
            ...
            // Remove existing spotlight if any (for HMR or re-renders)
    ...
    `;
            ...
            const handleMouseMove = (e: MouseEvent) => {
                ...
                // Check if mouse is near or inside the container
                const rect = containerRef.current.getBoundingClientRect();
                const buffer = 100; // Activation buffer around the container
                const mouseInside =
                ...
                cards.forEach(card => {
                    ...
                    // Improve distance calc to be from card edge roughly
                    const distance =
            ...
            // document vs window for mouseleave is tricky, window is usually safer for "left the window"
    ...
    useEffect(() => {
        ...
        const handleMouseMove = (e: MouseEvent) => {
            ...
            if (enableTilt) {
                ...
                const rotateY = ((x - centerX) / centerX) * 10; // Reversed tilt for feel
...
export const MagicContainer: React.FC<MagicContainerProps> = ({
    ...
    return (
        <div ref={containerRef} className={`magic-container relative ${className}`}>
            {enableSpotlight && (
                <GlobalSpotlight
