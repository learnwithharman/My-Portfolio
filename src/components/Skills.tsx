      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {skillCategories.map((category, index) => (
            <div key={index} className="glass-card rounded-[32px] p-8 flex flex-col group">
        ...
        <div className="glass-card rounded-[40px] p-10 md:p-16 border-white/5 relative overflow-hidden">
