...
const About = () => {
  ...
  return (
    <section id="about" className="py-32 px-6 relative overflow-hidden" aria-labelledby="about-heading">
      <div className="container mx-auto max-w-5xl">
        {/* Clickable Header - Centered & Premium */}
        <button
        ...
        <div
          className={`overflow-hidden transition-all duration-1000 ease-in-out ${isExpanded
            ? 'max-h-[1200px] opacity-100 mt-20'
            : 'max-h-0 opacity-0 mt-0'
            }`}
        >
          <div className={`glass-card rounded-2xl p-8 md:p-12 transform transition-all duration-500 ${isExpanded ? 'translate-y-0 scale-100' : '-translate-y-8 scale-95'
            }`}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
              ...
              <div className="md:col-span-1 flex justify-center md:justify-start">
                <div className="relative group/avatar">
                  ...
                  {/* Non-rotatory decorative circle */}
